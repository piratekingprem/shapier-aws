...
exports.store = async (params) => {
  ...
  try {
    const seller = await db.query(
      `INSERT INTO seller(mobile,company_name,contact_name,email,city,additional_info) VALUES(?,?,?,?,?,?)`,[params.mobile,params.company_name,params.contact_name,params.email,params.city,params.additional_info]
    );
